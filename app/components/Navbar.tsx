...
import { LogOut, History, BookOpen, Menu, Activity, Book } from "lucide-react"
          ...
          <div className="hidden md:flex items-center gap-2">
            {session ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={openSignUp}
                  className="rounded-lg bg-purple-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-purple-700 hover:cursor-pointer shadow-lg shadow-purple-500/20"
                >
                  Sign Up
                </button>
              </div>
            ...
            {session ? (
              ...
              <div className="flex gap-2 mt-4">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-lg border border-white/10 text-slate-200 font-semibold text-sm"
                >
                  Sign In
                </button>
                <button
                  onClick={() => { openSignUp(); setIsMobileMenuOpen(false); }}
                  className="flex-1 bg-purple-600 py-2.5 rounded-lg text-white font-bold text-sm"
                >
                  Sign Up
                </button>
              </div>
